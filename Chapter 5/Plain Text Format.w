...
=
void PlainText::top(weave_format *self, text_stream *OUT, weave_order *wv,
	text_stream *comment) {
	WRITE("[%S]\n", comment);
}
...
@ =
void PlainText::paragraph_heading(weave_format *self, text_stream *OUT, weave_order *wv,
...
@ =
void PlainText::display_line(weave_format *self, text_stream *OUT, weave_order *wv,
	text_stream *from) {
	WRITE("    %S\n", from);
}

@ =
void PlainText::item(weave_format *self, text_stream *OUT, weave_order *wv,
...
@ =
void PlainText::bar(weave_format *self, text_stream *OUT, weave_order *wv) {
	WRITE("\n----------------------------------------------------------------------\n\n");
}
...
@ =
void PlainText::tail(weave_format *self, text_stream *OUT, weave_order *wv,
