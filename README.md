...
[Version](notes/versioning.md): 9.0-beta+1B92 'Invasion' (28 December 2025)
...
* Run **one of the following commands**.
	...
	* `bash inweb/scripts/first.sh macosintel`
...
* For Intel Macs running MacOS 10.14 ("Mojave"), use `macosintel`. This will produce
64-bit x86 executables; similarly, this is now deprecated.
* For Apple Silicon Macs, the majority of Macs manufactured since 2020 and all of
them since 2023, use `macosarm` or simply `macos`. This will produce 64-bit
ARM executables.
...
* Android support has existed in the past, but not at present.
