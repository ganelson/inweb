...
file: smorgasbord/smorgasbord.rmscript
    # {metadata: Title} {metadata: Version Number}

    Backslash: \\. Braces: \{ and \}. Tab: a\tb. Newline: black\nand white.

    Roughly speaking, {metadata: Semantic Version Number} ({metadata: Build Date}).

    Strictly speaking, {metadata: Semantic Version Number of: smorgasbord} ({metadata: Build Date of: smorgasbord}).

    I can see {list-of-webs}. Moreover, this is {web}.

    {set name: URL value: https://www.inform7.com}
    ...
    ----- | --------------- | ----------
    {repeat with: WEB in: {list-of-webs}}
    {metadata: Title of: {WEB}} | {metadata: Semantic Version Number of: {WEB}} | {metadata: Build Date of: {WEB}}
    {end-repeat}
